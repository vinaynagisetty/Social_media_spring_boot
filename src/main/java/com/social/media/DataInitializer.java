...
import com.social.media.models.SocilaGroup;
import com.social.media.repository.PostRepository;
import com.social.media.repository.SocailProfileRepository;
...
public class DataInitializer {
    ...
    private final SocailProfileRepository socialProfileRepository;
    private final PostRepository postRepository;

    public DataInitializer(SocialUserRepository userRepository,
                           SocialGroupRepository groupRepository,
                           SocailProfileRepository socialProfileRepository,
    ...
    public CommandLineRunner initializeData() {
        return args -> {
            ...
            // Create some groups
            SocilaGroup group1 = new SocilaGroup();
            SocilaGroup group2 = new SocilaGroup();
            ...
            user1.getSocilaGroups().add(group1);
            user2.getSocilaGroups().add(group1);
            user2.getSocilaGroups().add(group2);
            user3.getSocilaGroups().add(group2);
